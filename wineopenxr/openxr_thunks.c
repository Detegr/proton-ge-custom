...
static inline void convert_XrEnvironmentDepthImageAcquireInfoMETA_win32_to_host(const XrEnvironmentDepthImageAcquireInfoMETA32 *in, XrEnvironmentDepthImageAcquireInfoMETA *out)
{
    ...
    out->type = in->type;
    out->next = NULL;
    out->space = (XrSpace)(uintptr_t)UlongToPtr(in->space);
...
static inline void convert_XrHapticActionInfo_win32_to_host(const XrHapticActionInfo32 *in, XrHapticActionInfo *out)
{
    ...
    out->type = in->type;
    out->next = NULL;
    out->action = (XrAction)(uintptr_t)UlongToPtr(in->action);
...
static inline void convert_XrPlaneDetectorBeginInfoEXT_win32_to_host(const XrPlaneDetectorBeginInfoEXT32 *in, XrPlaneDetectorBeginInfoEXT *out)
{
    ...
    out->type = in->type;
    out->next = NULL;
    out->baseSpace = (XrSpace)(uintptr_t)UlongToPtr(in->baseSpace);
    out->time = in->time;
...
static inline void convert_XrAnchorSpaceCreateInfoBD_win32_to_host(const XrAnchorSpaceCreateInfoBD32 *in, XrAnchorSpaceCreateInfoBD *out)
{
    ...
    out->type = in->type;
    out->next = NULL;
    out->anchor = (XrAnchorBD)(uintptr_t)UlongToPtr(in->anchor);
...
static inline void convert_XrGeometryInstanceCreateInfoFB_win32_to_host(const XrGeometryInstanceCreateInfoFB32 *in, XrGeometryInstanceCreateInfoFB *out)
{
    ...
    out->type = in->type;
    out->next = NULL;
    out->layer = (XrPassthroughLayerFB)(uintptr_t)UlongToPtr(in->layer);
    out->mesh = (XrTriangleMeshFB)(uintptr_t)UlongToPtr(in->mesh);
    out->baseSpace = (XrSpace)(uintptr_t)UlongToPtr(in->baseSpace);
    out->pose = in->pose;
    out->scale = in->scale;
    if (in->next)
...
static inline void convert_XrMarkerSpaceCreateInfoML_win32_to_host(const XrMarkerSpaceCreateInfoML32 *in, XrMarkerSpaceCreateInfoML *out)
{
    ...
    out->type = in->type;
    out->next = NULL;
    out->markerDetector = (XrMarkerDetectorML)(uintptr_t)UlongToPtr(in->markerDetector);
...
static inline void convert_XrPassthroughLayerCreateInfoFB_win32_to_host(const XrPassthroughLayerCreateInfoFB32 *in, XrPassthroughLayerCreateInfoFB *out)
{
    ...
    out->type = in->type;
    out->next = NULL;
    out->passthrough = (XrPassthroughFB)(uintptr_t)UlongToPtr(in->passthrough);
    out->flags = in->flags;
...
static inline void convert_XrRenderModelSpaceCreateInfoEXT_win32_to_host(const XrRenderModelSpaceCreateInfoEXT32 *in, XrRenderModelSpaceCreateInfoEXT *out)
{
    ...
    out->type = in->type;
    out->next = NULL;
    out->renderModel = (XrRenderModelEXT)(uintptr_t)UlongToPtr(in->renderModel);
    if (in->next)
        FIXME("Unexpected next\n");
}
...
static inline void convert_XrSpatialAnchorCreateCompletionBD_host_to_win32(const XrSpatialAnchorCreateCompletionBD *in, XrSpatialAnchorCreateCompletionBD32 *out)
{
    ...
    out->futureResult = in->futureResult;
    out->uuid = in->uuid;
    out->anchor = PtrToUlong(in->anchor);
}
...
static inline void convert_XrSpatialAnchorFromPersistedAnchorCreateInfoMSFT_win32_to_host(const XrSpatialAnchorFromPersistedAnchorCreateInfoMSFT32 *in, XrSpatialAnchorFromPersistedAnchorCreateInfoMSFT *out)
{
    ...
    out->type = in->type;
    out->next = NULL;
    out->spatialAnchorStore = (XrSpatialAnchorStoreConnectionMSFT)(uintptr_t)UlongToPtr(in->spatialAnchorStore);
...
static inline void convert_XrSpatialAnchorSpaceCreateInfoMSFT_win32_to_host(const XrSpatialAnchorSpaceCreateInfoMSFT32 *in, XrSpatialAnchorSpaceCreateInfoMSFT *out)
{
    ...
    out->type = in->type;
    out->next = NULL;
    out->anchor = (XrSpatialAnchorMSFT)(uintptr_t)UlongToPtr(in->anchor);
    out->poseInAnchorSpace = in->poseInAnchorSpace;
    if (in->next)
        FIXME("Unexpected next\n");
}
...
static inline void convert_XrCreateSpatialContextCompletionEXT_win32_to_host(const XrCreateSpatialContextCompletionEXT32 *in, XrCreateSpatialContextCompletionEXT *out)
{
    ...
    out->next = NULL;
    out->futureResult = in->futureResult;
    out->spatialContext = (XrSpatialContextEXT)(uintptr_t)UlongToPtr(in->spatialContext);
    if (in->next)
        FIXME("Unexpected next\n");
}
...
static inline void convert_XrCreateSpatialContextCompletionEXT_host_to_win32(const XrCreateSpatialContextCompletionEXT *in, XrCreateSpatialContextCompletionEXT32 *out)
{
    ...
    out->futureResult = in->futureResult;
    out->spatialContext = PtrToUlong(in->spatialContext);
}
...
static inline void convert_XrCreateSpatialDiscoverySnapshotCompletionEXT_win32_to_host(const XrCreateSpatialDiscoverySnapshotCompletionEXT32 *in, XrCreateSpatialDiscoverySnapshotCompletionEXT *out)
{
    ...
    out->next = NULL;
    out->futureResult = in->futureResult;
    out->snapshot = (XrSpatialSnapshotEXT)(uintptr_t)UlongToPtr(in->snapshot);
    if (in->next)
        FIXME("Unexpected next\n");
}
...
static inline void convert_XrCreateSpatialDiscoverySnapshotCompletionEXT_host_to_win32(const XrCreateSpatialDiscoverySnapshotCompletionEXT *in, XrCreateSpatialDiscoverySnapshotCompletionEXT32 *out)
{
    ...
    out->futureResult = in->futureResult;
    out->snapshot = PtrToUlong(in->snapshot);
}
...
static inline void convert_XrSpatialEntityAnchorCreateInfoBD_win32_to_host(const XrSpatialEntityAnchorCreateInfoBD32 *in, XrSpatialEntityAnchorCreateInfoBD *out)
{
    ...
    out->type = in->type;
    out->next = NULL;
    out->snapshot = (XrSenseDataSnapshotBD)(uintptr_t)UlongToPtr(in->snapshot);
...
static inline void convert_XrCreateSpatialPersistenceContextCompletionEXT_win32_to_host(const XrCreateSpatialPersistenceContextCompletionEXT32 *in, XrCreateSpatialPersistenceContextCompletionEXT *out)
{
    ...
    out->persistenceContext = (XrSpatialPersistenceContextEXT)(uintptr_t)UlongToPtr(in->persistenceContext);
    if (in->next)
        FIXME("Unexpected next\n");
}
...
static inline void convert_XrCreateSpatialPersistenceContextCompletionEXT_host_to_win32(const XrCreateSpatialPersistenceContextCompletionEXT *in, XrCreateSpatialPersistenceContextCompletionEXT32 *out)
{
    ...
    out->futureResult = in->futureResult;
    out->createResult = in->createResult;
    out->persistenceContext = PtrToUlong(in->persistenceContext);
}
...
static inline void convert_XrPassthroughStyleFB_win32_to_host(struct conversion_context *ctx, const XrPassthroughStyleFB32 *in, XrPassthroughStyleFB *out)
{
    ...
    for (in_header = (const XrBaseInStructure32 *)(uintptr_t)UlongToPtr(in->next); in_header; in_header = (const XrBaseInStructure32 *)(uintptr_t)UlongToPtr(in_header->next))
    {
        ...
        case XR_TYPE_PASSTHROUGH_COLOR_MAP_LUT_META:
        {
            ...
            out_ext->next = NULL;
            out_ext->colorLut = (XrPassthroughColorLutMETA)(uintptr_t)UlongToPtr(in_ext->colorLut);
        ...
        case XR_TYPE_PASSTHROUGH_COLOR_MAP_INTERPOLATED_LUT_META:
        {
            ...
            out_ext->next = NULL;
            out_ext->sourceColorLut = (XrPassthroughColorLutMETA)(uintptr_t)UlongToPtr(in_ext->sourceColorLut);
            out_ext->targetColorLut = (XrPassthroughColorLutMETA)(uintptr_t)UlongToPtr(in_ext->targetColorLut);
            out_ext->weight = in_ext->weight;
            out_header->next = (void *)out_ext;
            out_header = (void *)out_ext;
            break;
...
static inline void convert_XrPersistedAnchorSpaceInfoANDROID_win32_to_host(const XrPersistedAnchorSpaceInfoANDROID32 *in, XrPersistedAnchorSpaceInfoANDROID *out)
{
    ...
    out->type = in->type;
    out->next = NULL;
    out->anchor = (XrSpace)(uintptr_t)UlongToPtr(in->anchor);
    if (in->next)
        FIXME("Unexpected next\n");
}
...
static inline void convert_XrSpatialAnchorPersistenceInfoMSFT_win32_to_host(const XrSpatialAnchorPersistenceInfoMSFT32 *in, XrSpatialAnchorPersistenceInfoMSFT *out)
{
    ...
    out->next = NULL;
    out->spatialAnchorPersistenceName = in->spatialAnchorPersistenceName;
    out->spatialAnchor = (XrSpatialAnchorMSFT)(uintptr_t)UlongToPtr(in->spatialAnchor);
    if (in->next)
        FIXME("Unexpected next\n");
}
...
static inline void convert_XrWorldMeshRequestCompletionInfoML_win32_to_host(const XrWorldMeshRequestCompletionInfoML32 *in, XrWorldMeshRequestCompletionInfoML *out)
{
    ...
    out->type = in->type;
    out->next = NULL;
    out->meshSpace = (XrSpace)(uintptr_t)UlongToPtr(in->meshSpace);
...
static inline void convert_XrVirtualKeyboardInputInfoMETA_win32_to_host(const XrVirtualKeyboardInputInfoMETA32 *in, XrVirtualKeyboardInputInfoMETA *out)
{
    ...
    out->inputSpace = (XrSpace)(uintptr_t)UlongToPtr(in->inputSpace);
...
static inline void convert_XrActiveActionSetPriorityEXT_win32_to_host(const XrActiveActionSetPriorityEXT32 *in, XrActiveActionSetPriorityEXT *out)
{
    ...
    out->actionSet = (XrActionSet)(uintptr_t)UlongToPtr(in->actionSet);
...
static NTSTATUS thunk32_xrAcquireEnvironmentDepthImageMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrAcquireEnvironmentDepthImageMETA((XrEnvironmentDepthProviderMETA)(uintptr_t)UlongToPtr(params->environmentDepthProvider), &acquireInfo_host, &environmentDepthImage_host);
...
static NTSTATUS thunk32_xrAcquireSwapchainImage(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrAcquireSwapchainImage(wine_swapchain_from_handle((XrSwapchain)(uintptr_t)UlongToPtr(params->swapchain))->host_swapchain, acquireInfo_host, (uint32_t *)(uintptr_t)UlongToPtr(params->index));
...
static NTSTATUS thunk32_xrAllocateWorldMeshBufferML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrAllocateWorldMeshBufferML((XrWorldMeshDetectorML)(uintptr_t)UlongToPtr(params->detector), &size_host, &buffer_host);
...
static NTSTATUS thunk32_xrApplyForceFeedbackCurlMNDX(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrApplyForceFeedbackCurlMNDX((XrHandTrackerEXT)(uintptr_t)UlongToPtr(params->handTracker), &locations_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrApplyHapticFeedback(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrApplyHapticFeedback(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &hapticActionInfo_host, &hapticFeedback_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrAttachSessionActionSets(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrAttachSessionActionSets(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &attachInfo_host);
    free_conversion_context(ctx);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrBeginFrame(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrBeginFrame(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, frameBeginInfo_host);
    free_conversion_context(ctx);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrBeginPlaneDetectionEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrBeginPlaneDetectionEXT((XrPlaneDetectorEXT)(uintptr_t)UlongToPtr(params->planeDetector), &beginInfo_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrBeginSession(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrBeginSession(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &beginInfo_host);
    free_conversion_context(ctx);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrCancelFutureEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCancelFutureEXT(wine_instance_from_handle((XrInstance)(uintptr_t)UlongToPtr(params->instance))->host_instance, &cancelInfo_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrCaptureSceneAsyncBD(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCaptureSceneAsyncBD((XrSenseDataProviderBD)(uintptr_t)UlongToPtr(params->provider), &info_host, (XrFutureEXT *)(uintptr_t)UlongToPtr(params->future));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrCaptureSceneCompleteBD(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCaptureSceneCompleteBD((XrSenseDataProviderBD)(uintptr_t)UlongToPtr(params->provider), params->future, &completion_host);
...
static NTSTATUS thunk32_xrChangeVirtualKeyboardTextContextMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrChangeVirtualKeyboardTextContextMETA((XrVirtualKeyboardMETA)(uintptr_t)UlongToPtr(params->keyboard), &changeInfo_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrClearSpatialAnchorStoreMSFT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrClearSpatialAnchorStoreMSFT((XrSpatialAnchorStoreConnectionMSFT)(uintptr_t)UlongToPtr(params->spatialAnchorStore));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrComputeNewSceneMSFT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrComputeNewSceneMSFT((XrSceneObserverMSFT)(uintptr_t)UlongToPtr(params->sceneObserver), &computeInfo_host);
    free_conversion_context(ctx);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrCreateAction(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateAction((XrActionSet)(uintptr_t)UlongToPtr(params->actionSet), &createInfo_host, &action_host);
...
static NTSTATUS thunk32_xrCreateActionSet(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateActionSet(wine_instance_from_handle((XrInstance)(uintptr_t)UlongToPtr(params->instance))->host_instance, &createInfo_host, &actionSet_host);
...
static NTSTATUS thunk32_xrCreateActionSpace(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateActionSpace(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &space_host);
...
static NTSTATUS thunk32_xrCreateAnchorSpaceANDROID(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateAnchorSpaceANDROID(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &anchorOutput_host);
...
static NTSTATUS thunk32_xrCreateAnchorSpaceBD(void *args)
{
    ...
    space_host = (XrSpace)(uintptr_t)UlongToPtr(*(PTR32 *)(uintptr_t)UlongToPtr(params->space));
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateAnchorSpaceBD(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &space_host);
    *(PTR32 *)(uintptr_t)UlongToPtr(params->space) = PtrToUlong(space_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrCreateBodyTrackerBD(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateBodyTrackerBD(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &bodyTracker_host);
...
static NTSTATUS thunk32_xrCreateBodyTrackerFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateBodyTrackerFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &bodyTracker_host);
    *(PTR32 *)(uintptr_t)UlongToPtr(params->bodyTracker) = PtrToUlong(bodyTracker_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrCreateBodyTrackerHTC(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateBodyTrackerHTC(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &bodyTracker_host);
    *(PTR32 *)(uintptr_t)UlongToPtr(params->bodyTracker) = PtrToUlong(bodyTracker_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrCreateDeviceAnchorPersistenceANDROID(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateDeviceAnchorPersistenceANDROID(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &outHandle_host);
...
static NTSTATUS thunk32_xrCreateEnvironmentDepthProviderMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateEnvironmentDepthProviderMETA(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &environmentDepthProvider_host);
...
static NTSTATUS thunk32_xrCreateEnvironmentDepthSwapchainMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateEnvironmentDepthSwapchainMETA((XrEnvironmentDepthProviderMETA)(uintptr_t)UlongToPtr(params->environmentDepthProvider), &createInfo_host, &swapchain_host);
...
static NTSTATUS thunk32_xrCreateExportedLocalizationMapML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateExportedLocalizationMapML(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, (const XrUuidEXT *)(uintptr_t)UlongToPtr(params->mapUuid), &map_host);
...
static NTSTATUS thunk32_xrCreateEyeTrackerFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateEyeTrackerFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &eyeTracker_host);
...
static NTSTATUS thunk32_xrCreateFaceTracker2FB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateFaceTracker2FB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &faceTracker_host);
...
static NTSTATUS thunk32_xrCreateFaceTrackerFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateFaceTrackerFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &faceTracker_host);
    *(PTR32 *)(uintptr_t)UlongToPtr(params->faceTracker) = PtrToUlong(faceTracker_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrCreateFacialExpressionClientML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateFacialExpressionClientML(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &facialExpressionClient_host);
...
static NTSTATUS thunk32_xrCreateFacialTrackerHTC(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateFacialTrackerHTC(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &facialTracker_host);
...
static NTSTATUS thunk32_xrCreateFoveationProfileFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateFoveationProfileFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &profile_host);
...
static NTSTATUS thunk32_xrCreateGeometryInstanceFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateGeometryInstanceFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &outGeometryInstance_host);
...
static NTSTATUS thunk32_xrCreateHandMeshSpaceMSFT(void *args)
{
    ...
    space_host = (XrSpace)(uintptr_t)UlongToPtr(*(PTR32 *)(uintptr_t)UlongToPtr(params->space));
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateHandMeshSpaceMSFT((XrHandTrackerEXT)(uintptr_t)UlongToPtr(params->handTracker), &createInfo_host, &space_host);
    *(PTR32 *)(uintptr_t)UlongToPtr(params->space) = PtrToUlong(space_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrCreateHandTrackerEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateHandTrackerEXT(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &handTracker_host);
...
static NTSTATUS thunk32_xrCreateKeyboardSpaceFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateKeyboardSpaceFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &keyboardSpace_host);
...
static NTSTATUS thunk32_xrCreateMarkerDetectorML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateMarkerDetectorML(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &markerDetector_host);
...
static NTSTATUS thunk32_xrCreateMarkerSpaceML(void *args)
{
    ...
    space_host = (XrSpace)(uintptr_t)UlongToPtr(*(PTR32 *)(uintptr_t)UlongToPtr(params->space));
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateMarkerSpaceML(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &space_host);
    *(PTR32 *)(uintptr_t)UlongToPtr(params->space) = PtrToUlong(space_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrCreateMarkerSpaceVARJO(void *args)
{
    ...
    space_host = (XrSpace)(uintptr_t)UlongToPtr(*(PTR32 *)(uintptr_t)UlongToPtr(params->space));
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateMarkerSpaceVARJO(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &space_host);
    *(PTR32 *)(uintptr_t)UlongToPtr(params->space) = PtrToUlong(space_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrCreatePassthroughColorLutMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreatePassthroughColorLutMETA((XrPassthroughFB)(uintptr_t)UlongToPtr(params->passthrough), &createInfo_host, &colorLut_host);
...
static NTSTATUS thunk32_xrCreatePassthroughFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreatePassthroughFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &outPassthrough_host);
...
static NTSTATUS thunk32_xrCreatePassthroughHTC(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreatePassthroughHTC(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &passthrough_host);
...
static NTSTATUS thunk32_xrCreatePassthroughLayerFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreatePassthroughLayerFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &outLayer_host);
...
static NTSTATUS thunk32_xrCreatePersistedAnchorSpaceANDROID(void *args)
{
    ...
    anchorOutput_host = (XrSpace)(uintptr_t)UlongToPtr(*(PTR32 *)(uintptr_t)UlongToPtr(params->anchorOutput));
    params->result = g_xr_host_instance_dispatch_table.p_xrCreatePersistedAnchorSpaceANDROID((XrDeviceAnchorPersistenceANDROID)(uintptr_t)UlongToPtr(params->handle), &createInfo_host, &anchorOutput_host);
    *(PTR32 *)(uintptr_t)UlongToPtr(params->anchorOutput) = PtrToUlong(anchorOutput_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrCreatePlaneDetectorEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreatePlaneDetectorEXT(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &planeDetector_host);
...
static NTSTATUS thunk32_xrCreateReferenceSpace(void *args)
{
    ...
    space_host = (XrSpace)(uintptr_t)UlongToPtr(*(PTR32 *)(uintptr_t)UlongToPtr(params->space));
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateReferenceSpace(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &space_host);
    *(PTR32 *)(uintptr_t)UlongToPtr(params->space) = PtrToUlong(space_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrCreateRenderModelAssetEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateRenderModelAssetEXT(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &asset_host);
...
static NTSTATUS thunk32_xrCreateRenderModelEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateRenderModelEXT(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &renderModel_host);
...
static NTSTATUS thunk32_xrCreateRenderModelSpaceEXT(void *args)
{
    ...
    space_host = (XrSpace)(uintptr_t)UlongToPtr(*(PTR32 *)(uintptr_t)UlongToPtr(params->space));
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateRenderModelSpaceEXT(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &space_host);
    *(PTR32 *)(uintptr_t)UlongToPtr(params->space) = PtrToUlong(space_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrCreateSceneMSFT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateSceneMSFT((XrSceneObserverMSFT)(uintptr_t)UlongToPtr(params->sceneObserver), createInfo_host, &scene_host);
...
static NTSTATUS thunk32_xrCreateSceneObserverMSFT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateSceneObserverMSFT(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, createInfo_host, &sceneObserver_host);
...
static NTSTATUS thunk32_xrCreateSenseDataProviderBD(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateSenseDataProviderBD(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &provider_host);
...
static NTSTATUS thunk32_xrCreateSession(void *args)
{
    ...
    params->result = wine_xrCreateSession((XrInstance)(uintptr_t)UlongToPtr(params->instance), &createInfo_host, &session_host);
...
static NTSTATUS thunk32_xrCreateSpaceUserFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateSpaceUserFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &info_host, &user_host);
...
static NTSTATUS thunk32_xrCreateSpatialAnchorAsyncBD(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateSpatialAnchorAsyncBD((XrSenseDataProviderBD)(uintptr_t)UlongToPtr(params->provider), &info_host, (XrFutureEXT *)(uintptr_t)UlongToPtr(params->future));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrCreateSpatialAnchorCompleteBD(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateSpatialAnchorCompleteBD((XrSenseDataProviderBD)(uintptr_t)UlongToPtr(params->provider), params->future, &completion_host);
...
static NTSTATUS thunk32_xrCreateSpatialAnchorEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateSpatialAnchorEXT((XrSpatialContextEXT)(uintptr_t)UlongToPtr(params->spatialContext), &createInfo_host, (XrSpatialEntityIdEXT *)(uintptr_t)UlongToPtr(params->anchorEntityId), &anchorEntity_host);
...
static NTSTATUS thunk32_xrCreateSpatialAnchorFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateSpatialAnchorFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &info_host, (XrAsyncRequestIdFB *)(uintptr_t)UlongToPtr(params->requestId));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrCreateSpatialAnchorFromPersistedNameMSFT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateSpatialAnchorFromPersistedNameMSFT(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &spatialAnchorCreateInfo_host, &spatialAnchor_host);
...
static NTSTATUS thunk32_xrCreateSpatialAnchorHTC(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateSpatialAnchorHTC(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &anchor_host);
...
static NTSTATUS thunk32_xrCreateSpatialAnchorMSFT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateSpatialAnchorMSFT(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &anchor_host);
    *(PTR32 *)(uintptr_t)UlongToPtr(params->anchor) = PtrToUlong(anchor_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrCreateSpatialAnchorSpaceMSFT(void *args)
{
    ...
    space_host = (XrSpace)(uintptr_t)UlongToPtr(*(PTR32 *)(uintptr_t)UlongToPtr(params->space));
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateSpatialAnchorSpaceMSFT(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &space_host);
    *(PTR32 *)(uintptr_t)UlongToPtr(params->space) = PtrToUlong(space_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrCreateSpatialAnchorStoreConnectionMSFT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateSpatialAnchorStoreConnectionMSFT(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &spatialAnchorStore_host);
...
static NTSTATUS thunk32_xrCreateSpatialAnchorsAsyncML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateSpatialAnchorsAsyncML(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, (XrFutureEXT *)(uintptr_t)UlongToPtr(params->future));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrCreateSpatialAnchorsCompleteML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateSpatialAnchorsCompleteML(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->future, &completion_host);
...
static NTSTATUS thunk32_xrCreateSpatialAnchorsStorageML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateSpatialAnchorsStorageML(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &storage_host);
...
static NTSTATUS thunk32_xrCreateSpatialContextAsyncEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateSpatialContextAsyncEXT(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, (XrFutureEXT *)(uintptr_t)UlongToPtr(params->future));
    free_conversion_context(ctx);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrCreateSpatialContextCompleteEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateSpatialContextCompleteEXT(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->future, &completion_host);
...
static NTSTATUS thunk32_xrCreateSpatialDiscoverySnapshotAsyncEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateSpatialDiscoverySnapshotAsyncEXT((XrSpatialContextEXT)(uintptr_t)UlongToPtr(params->spatialContext), &createInfo_host, (XrFutureEXT *)(uintptr_t)UlongToPtr(params->future));
    free_conversion_context(ctx);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrCreateSpatialDiscoverySnapshotCompleteEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateSpatialDiscoverySnapshotCompleteEXT((XrSpatialContextEXT)(uintptr_t)UlongToPtr(params->spatialContext), &createSnapshotCompletionInfo_host, &completion_host);
...
static NTSTATUS thunk32_xrCreateSpatialEntityAnchorBD(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateSpatialEntityAnchorBD((XrSenseDataProviderBD)(uintptr_t)UlongToPtr(params->provider), &createInfo_host, &anchor_host);
    *(PTR32 *)(uintptr_t)UlongToPtr(params->anchor) = PtrToUlong(anchor_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrCreateSpatialEntityFromIdEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateSpatialEntityFromIdEXT((XrSpatialContextEXT)(uintptr_t)UlongToPtr(params->spatialContext), &createInfo_host, &spatialEntity_host);
...
static NTSTATUS thunk32_xrCreateSpatialGraphNodeSpaceMSFT(void *args)
{
    ...
    space_host = (XrSpace)(uintptr_t)UlongToPtr(*(PTR32 *)(uintptr_t)UlongToPtr(params->space));
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateSpatialGraphNodeSpaceMSFT(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &space_host);
    *(PTR32 *)(uintptr_t)UlongToPtr(params->space) = PtrToUlong(space_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrCreateSpatialPersistenceContextAsyncEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateSpatialPersistenceContextAsyncEXT(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, (XrFutureEXT *)(uintptr_t)UlongToPtr(params->future));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrCreateSpatialPersistenceContextCompleteEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateSpatialPersistenceContextCompleteEXT(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->future, &completion_host);
...
static NTSTATUS thunk32_xrCreateSpatialUpdateSnapshotEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateSpatialUpdateSnapshotEXT((XrSpatialContextEXT)(uintptr_t)UlongToPtr(params->spatialContext), &createInfo_host, &snapshot_host);
...
static NTSTATUS thunk32_xrCreateSwapchain(void *args)
{
    ...
    params->result = wine_xrCreateSwapchain((XrSession)(uintptr_t)UlongToPtr(params->session), &createInfo_host, &swapchain_host);
    *(PTR32 *)(uintptr_t)UlongToPtr(params->swapchain) = PtrToUlong(swapchain_host);
    free_conversion_context(ctx);
    return STATUS_SUCCESS;
}
...
static NTSTATUS thunk32_xrCreateTrackableTrackerANDROID(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateTrackableTrackerANDROID(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &trackableTracker_host);
...
static NTSTATUS thunk32_xrCreateTriangleMeshFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateTriangleMeshFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &outTriangleMesh_host);
...
static NTSTATUS thunk32_xrCreateVirtualKeyboardMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateVirtualKeyboardMETA(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &keyboard_host);
...
static NTSTATUS thunk32_xrCreateVirtualKeyboardSpaceMETA(void *args)
{
    ...
    keyboardSpace_host = (XrSpace)(uintptr_t)UlongToPtr(*(PTR32 *)(uintptr_t)UlongToPtr(params->keyboardSpace));
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateVirtualKeyboardSpaceMETA(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, (XrVirtualKeyboardMETA)(uintptr_t)UlongToPtr(params->keyboard), &createInfo_host, &keyboardSpace_host);
    *(PTR32 *)(uintptr_t)UlongToPtr(params->keyboardSpace) = PtrToUlong(keyboardSpace_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrCreateWorldMeshDetectorML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrCreateWorldMeshDetectorML(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &detector_host);
...
static NTSTATUS thunk32_xrDeleteSpatialAnchorsAsyncML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDeleteSpatialAnchorsAsyncML((XrSpatialAnchorsStorageML)(uintptr_t)UlongToPtr(params->storage), &deleteInfo_host, (XrFutureEXT *)(uintptr_t)UlongToPtr(params->future));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDeleteSpatialAnchorsCompleteML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDeleteSpatialAnchorsCompleteML((XrSpatialAnchorsStorageML)(uintptr_t)UlongToPtr(params->storage), params->future, &completion_host);
...
static NTSTATUS thunk32_xrDeserializeSceneMSFT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDeserializeSceneMSFT((XrSceneObserverMSFT)(uintptr_t)UlongToPtr(params->sceneObserver), &deserializeInfo_host);
    free_conversion_context(ctx);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyAction(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyAction((XrAction)(uintptr_t)UlongToPtr(params->action));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyActionSet(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyActionSet((XrActionSet)(uintptr_t)UlongToPtr(params->actionSet));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyAnchorBD(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyAnchorBD((XrAnchorBD)(uintptr_t)UlongToPtr(params->anchor));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyBodyTrackerBD(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyBodyTrackerBD((XrBodyTrackerBD)(uintptr_t)UlongToPtr(params->bodyTracker));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyBodyTrackerFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyBodyTrackerFB((XrBodyTrackerFB)(uintptr_t)UlongToPtr(params->bodyTracker));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyBodyTrackerHTC(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyBodyTrackerHTC((XrBodyTrackerHTC)(uintptr_t)UlongToPtr(params->bodyTracker));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyDeviceAnchorPersistenceANDROID(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyDeviceAnchorPersistenceANDROID((XrDeviceAnchorPersistenceANDROID)(uintptr_t)UlongToPtr(params->handle));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyEnvironmentDepthProviderMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyEnvironmentDepthProviderMETA((XrEnvironmentDepthProviderMETA)(uintptr_t)UlongToPtr(params->environmentDepthProvider));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyEnvironmentDepthSwapchainMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyEnvironmentDepthSwapchainMETA((XrEnvironmentDepthSwapchainMETA)(uintptr_t)UlongToPtr(params->swapchain));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyExportedLocalizationMapML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyExportedLocalizationMapML((XrExportedLocalizationMapML)(uintptr_t)UlongToPtr(params->map));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyEyeTrackerFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyEyeTrackerFB((XrEyeTrackerFB)(uintptr_t)UlongToPtr(params->eyeTracker));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyFaceTracker2FB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyFaceTracker2FB((XrFaceTracker2FB)(uintptr_t)UlongToPtr(params->faceTracker));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyFaceTrackerFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyFaceTrackerFB((XrFaceTrackerFB)(uintptr_t)UlongToPtr(params->faceTracker));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyFacialExpressionClientML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyFacialExpressionClientML((XrFacialExpressionClientML)(uintptr_t)UlongToPtr(params->facialExpressionClient));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyFacialTrackerHTC(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyFacialTrackerHTC((XrFacialTrackerHTC)(uintptr_t)UlongToPtr(params->facialTracker));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyFoveationProfileFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyFoveationProfileFB((XrFoveationProfileFB)(uintptr_t)UlongToPtr(params->profile));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyGeometryInstanceFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyGeometryInstanceFB((XrGeometryInstanceFB)(uintptr_t)UlongToPtr(params->instance));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyHandTrackerEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyHandTrackerEXT((XrHandTrackerEXT)(uintptr_t)UlongToPtr(params->handTracker));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyInstance(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyInstance(wine_instance_from_handle((XrInstance)(uintptr_t)UlongToPtr(params->instance))->host_instance);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyMarkerDetectorML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyMarkerDetectorML((XrMarkerDetectorML)(uintptr_t)UlongToPtr(params->markerDetector));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyPassthroughColorLutMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyPassthroughColorLutMETA((XrPassthroughColorLutMETA)(uintptr_t)UlongToPtr(params->colorLut));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyPassthroughFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyPassthroughFB((XrPassthroughFB)(uintptr_t)UlongToPtr(params->passthrough));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyPassthroughHTC(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyPassthroughHTC((XrPassthroughHTC)(uintptr_t)UlongToPtr(params->passthrough));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyPassthroughLayerFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyPassthroughLayerFB((XrPassthroughLayerFB)(uintptr_t)UlongToPtr(params->layer));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyPlaneDetectorEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyPlaneDetectorEXT((XrPlaneDetectorEXT)(uintptr_t)UlongToPtr(params->planeDetector));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyRenderModelAssetEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyRenderModelAssetEXT((XrRenderModelAssetEXT)(uintptr_t)UlongToPtr(params->asset));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyRenderModelEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyRenderModelEXT((XrRenderModelEXT)(uintptr_t)UlongToPtr(params->renderModel));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroySceneMSFT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroySceneMSFT((XrSceneMSFT)(uintptr_t)UlongToPtr(params->scene));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroySceneObserverMSFT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroySceneObserverMSFT((XrSceneObserverMSFT)(uintptr_t)UlongToPtr(params->sceneObserver));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroySenseDataProviderBD(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroySenseDataProviderBD((XrSenseDataProviderBD)(uintptr_t)UlongToPtr(params->provider));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroySenseDataSnapshotBD(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroySenseDataSnapshotBD((XrSenseDataSnapshotBD)(uintptr_t)UlongToPtr(params->snapshot));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroySession(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroySession(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroySpace(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroySpace((XrSpace)(uintptr_t)UlongToPtr(params->space));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroySpaceUserFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroySpaceUserFB((XrSpaceUserFB)(uintptr_t)UlongToPtr(params->user));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroySpatialAnchorMSFT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroySpatialAnchorMSFT((XrSpatialAnchorMSFT)(uintptr_t)UlongToPtr(params->anchor));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroySpatialAnchorStoreConnectionMSFT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroySpatialAnchorStoreConnectionMSFT((XrSpatialAnchorStoreConnectionMSFT)(uintptr_t)UlongToPtr(params->spatialAnchorStore));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroySpatialAnchorsStorageML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroySpatialAnchorsStorageML((XrSpatialAnchorsStorageML)(uintptr_t)UlongToPtr(params->storage));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroySpatialContextEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroySpatialContextEXT((XrSpatialContextEXT)(uintptr_t)UlongToPtr(params->spatialContext));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroySpatialEntityEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroySpatialEntityEXT((XrSpatialEntityEXT)(uintptr_t)UlongToPtr(params->spatialEntity));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroySpatialGraphNodeBindingMSFT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroySpatialGraphNodeBindingMSFT((XrSpatialGraphNodeBindingMSFT)(uintptr_t)UlongToPtr(params->nodeBinding));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroySpatialPersistenceContextEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroySpatialPersistenceContextEXT((XrSpatialPersistenceContextEXT)(uintptr_t)UlongToPtr(params->persistenceContext));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroySpatialSnapshotEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroySpatialSnapshotEXT((XrSpatialSnapshotEXT)(uintptr_t)UlongToPtr(params->snapshot));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroySwapchain(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroySwapchain(wine_swapchain_from_handle((XrSwapchain)(uintptr_t)UlongToPtr(params->swapchain))->host_swapchain);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyTrackableTrackerANDROID(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyTrackableTrackerANDROID((XrTrackableTrackerANDROID)(uintptr_t)UlongToPtr(params->trackableTracker));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyTriangleMeshFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyTriangleMeshFB((XrTriangleMeshFB)(uintptr_t)UlongToPtr(params->mesh));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyVirtualKeyboardMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyVirtualKeyboardMETA((XrVirtualKeyboardMETA)(uintptr_t)UlongToPtr(params->keyboard));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDestroyWorldMeshDetectorML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDestroyWorldMeshDetectorML((XrWorldMeshDetectorML)(uintptr_t)UlongToPtr(params->detector));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDiscoverSpacesMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDiscoverSpacesMETA(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &info_host, (XrAsyncRequestIdFB *)(uintptr_t)UlongToPtr(params->requestId));
    free_conversion_context(ctx);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDownloadSharedSpatialAnchorAsyncBD(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrDownloadSharedSpatialAnchorAsyncBD((XrSenseDataProviderBD)(uintptr_t)UlongToPtr(params->provider), &info_host, (XrFutureEXT *)(uintptr_t)UlongToPtr(params->future));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrDownloadSharedSpatialAnchorCompleteBD(void *args)
{
    ...
    convert_XrFutureCompletionEXT_win32_to_host((XrFutureCompletionEXT32 *)(uintptr_t)UlongToPtr(params->completion), &completion_host);
    params->result = g_xr_host_instance_dispatch_table.p_xrDownloadSharedSpatialAnchorCompleteBD((XrSenseDataProviderBD)(uintptr_t)UlongToPtr(params->provider), params->future, &completion_host);
    convert_XrFutureCompletionEXT_host_to_win32(&completion_host, (XrFutureCompletionEXT32 *)(XrFutureCompletionEXT32 *)(uintptr_t)UlongToPtr(params->completion));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrEnableLocalizationEventsML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrEnableLocalizationEventsML(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &info_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrEnableUserCalibrationEventsML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrEnableUserCalibrationEventsML(wine_instance_from_handle((XrInstance)(uintptr_t)UlongToPtr(params->instance))->host_instance, &enableInfo_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrEndFrame(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrEndFrame(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &frameEndInfo_host);
    free_conversion_context(ctx);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrEndSession(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrEndSession(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrEnumerateBoundSourcesForAction(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrEnumerateBoundSourcesForAction(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &enumerateInfo_host, params->sourceCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->sourceCountOutput), (XrPath *)(uintptr_t)UlongToPtr(params->sources));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrEnumerateColorSpacesFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrEnumerateColorSpacesFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->colorSpaceCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->colorSpaceCountOutput), (XrColorSpaceFB *)(uintptr_t)UlongToPtr(params->colorSpaces));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrEnumerateDisplayRefreshRatesFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrEnumerateDisplayRefreshRatesFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->displayRefreshRateCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->displayRefreshRateCountOutput), (float *)(uintptr_t)UlongToPtr(params->displayRefreshRates));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrEnumerateEnvironmentDepthSwapchainImagesMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrEnumerateEnvironmentDepthSwapchainImagesMETA((XrEnvironmentDepthSwapchainMETA)(uintptr_t)UlongToPtr(params->swapchain), params->imageCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->imageCountOutput), images_host);
...
static NTSTATUS thunk32_xrEnumerateExternalCamerasOCULUS(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrEnumerateExternalCamerasOCULUS(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->cameraCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->cameraCountOutput), cameras_host);
...
static NTSTATUS thunk32_xrEnumerateInteractionRenderModelIdsEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrEnumerateInteractionRenderModelIdsEXT(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &getInfo_host, params->renderModelIdCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->renderModelIdCountOutput), (XrRenderModelIdEXT *)(uintptr_t)UlongToPtr(params->renderModelIds));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrEnumeratePerformanceMetricsCounterPathsMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrEnumeratePerformanceMetricsCounterPathsMETA(wine_instance_from_handle((XrInstance)(uintptr_t)UlongToPtr(params->instance))->host_instance, params->counterPathCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->counterPathCountOutput), (XrPath *)(uintptr_t)UlongToPtr(params->counterPaths));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrEnumeratePersistedAnchorsANDROID(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrEnumeratePersistedAnchorsANDROID((XrDeviceAnchorPersistenceANDROID)(uintptr_t)UlongToPtr(params->handle), params->anchorIdCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->anchorIdCountOutput), (XrUuidEXT *)(uintptr_t)UlongToPtr(params->anchorIds));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrEnumerateReferenceSpaces(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrEnumerateReferenceSpaces(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->spaceCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->spaceCountOutput), (XrReferenceSpaceType *)(uintptr_t)UlongToPtr(params->spaces));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrEnumerateRenderModelPathsFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrEnumerateRenderModelPathsFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->pathCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->pathCountOutput), paths_host);
...
static NTSTATUS thunk32_xrEnumerateRenderModelSubactionPathsEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrEnumerateRenderModelSubactionPathsEXT((XrRenderModelEXT)(uintptr_t)UlongToPtr(params->renderModel), info_host, params->pathCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->pathCountOutput), (XrPath *)(uintptr_t)UlongToPtr(params->paths));
    free_conversion_context(ctx);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrEnumerateSpaceSupportedComponentsFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrEnumerateSpaceSupportedComponentsFB((XrSpace)(uintptr_t)UlongToPtr(params->space), params->componentTypeCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->componentTypeCountOutput), (XrSpaceComponentTypeFB *)(uintptr_t)UlongToPtr(params->componentTypes));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrEnumerateSpatialCapabilityComponentTypesEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrEnumerateSpatialCapabilityComponentTypesEXT(wine_instance_from_handle((XrInstance)(uintptr_t)UlongToPtr(params->instance))->host_instance, params->systemId, params->capability, &capabilityComponents_host);
...
static NTSTATUS thunk32_xrEnumerateSpatialEntityComponentTypesBD(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrEnumerateSpatialEntityComponentTypesBD((XrSenseDataSnapshotBD)(uintptr_t)UlongToPtr(params->snapshot), params->entityId, params->componentTypeCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->componentTypeCountOutput), (XrSpatialEntityComponentTypeBD *)(uintptr_t)UlongToPtr(params->componentTypes));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrEnumerateSupportedAnchorTrackableTypesANDROID(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrEnumerateSupportedAnchorTrackableTypesANDROID(wine_instance_from_handle((XrInstance)(uintptr_t)UlongToPtr(params->instance))->host_instance, params->systemId, params->trackableTypeCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->trackableTypeCountOutput), (XrTrackableTypeANDROID *)(uintptr_t)UlongToPtr(params->trackableTypes));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrEnumerateSwapchainFormats(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrEnumerateSwapchainFormats(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->formatCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->formatCountOutput), (int64_t *)(uintptr_t)UlongToPtr(params->formats));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrEnumerateSwapchainImages(void *args)
{
    ...
    init_conversion_context(ctx);
    images_host = convert_XrSwapchainImageBaseHeader_array_win32_to_host(ctx, (XrSwapchainImageBaseHeader32 *)(uintptr_t)UlongToPtr(params->images), params->imageCapacityInput);
    params->result = g_xr_host_instance_dispatch_table.p_xrEnumerateSwapchainImages(wine_swapchain_from_handle((XrSwapchain)(uintptr_t)UlongToPtr(params->swapchain))->host_swapchain, params->imageCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->imageCountOutput), images_host);
    convert_XrSwapchainImageBaseHeader_array_host_to_win32(images_host, (XrSwapchainImageBaseHeader32 *)(uintptr_t)UlongToPtr(params->images), params->imageCapacityInput);
    free_conversion_context(ctx);
    return STATUS_SUCCESS;
}
...
static NTSTATUS thunk32_xrEnumerateViewConfigurationViews(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrEnumerateViewConfigurationViews(wine_instance_from_handle((XrInstance)(uintptr_t)UlongToPtr(params->instance))->host_instance, params->systemId, params->viewConfigurationType, params->viewCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->viewCountOutput), views_host);
...
static NTSTATUS thunk32_xrEnumerateViveTrackerPathsHTCX(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrEnumerateViveTrackerPathsHTCX(wine_instance_from_handle((XrInstance)(uintptr_t)UlongToPtr(params->instance))->host_instance, params->pathCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->pathCountOutput), paths_host);
...
static NTSTATUS thunk32_xrEraseSpaceFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrEraseSpaceFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &info_host, (XrAsyncRequestIdFB *)(uintptr_t)UlongToPtr(params->requestId));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrEraseSpacesMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrEraseSpacesMETA(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &info_host, (XrAsyncRequestIdFB *)(uintptr_t)UlongToPtr(params->requestId));
...
static NTSTATUS thunk32_xrFreeWorldMeshBufferML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrFreeWorldMeshBufferML((XrWorldMeshDetectorML)(uintptr_t)UlongToPtr(params->detector), &buffer_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGeometryInstanceSetTransformFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGeometryInstanceSetTransformFB((XrGeometryInstanceFB)(uintptr_t)UlongToPtr(params->instance), &transformation_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetActionStateBoolean(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetActionStateBoolean(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &getInfo_host, &state_host);
...
static NTSTATUS thunk32_xrGetActionStateFloat(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetActionStateFloat(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &getInfo_host, &state_host);
...
static NTSTATUS thunk32_xrGetActionStatePose(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetActionStatePose(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &getInfo_host, &state_host);
...
static NTSTATUS thunk32_xrGetActionStateVector2f(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetActionStateVector2f(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &getInfo_host, &state_host);
...
static NTSTATUS thunk32_xrGetAllTrackablesANDROID(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetAllTrackablesANDROID((XrTrackableTrackerANDROID)(uintptr_t)UlongToPtr(params->trackableTracker), params->trackableCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->trackableCountOutput), (XrTrackableANDROID *)(uintptr_t)UlongToPtr(params->trackables));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetAnchorPersistStateANDROID(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetAnchorPersistStateANDROID((XrDeviceAnchorPersistenceANDROID)(uintptr_t)UlongToPtr(params->handle), (const XrUuidEXT *)(uintptr_t)UlongToPtr(params->anchorId), (XrAnchorPersistStateANDROID *)(uintptr_t)UlongToPtr(params->persistState));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetAnchorUuidBD(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetAnchorUuidBD((XrAnchorBD)(uintptr_t)UlongToPtr(params->anchor), (XrUuidEXT *)(uintptr_t)UlongToPtr(params->uuid));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetAudioInputDeviceGuidOculus(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetAudioInputDeviceGuidOculus(wine_instance_from_handle((XrInstance)(uintptr_t)UlongToPtr(params->instance))->host_instance, (wchar_t *)(uintptr_t)UlongToPtr(params->buffer));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetAudioOutputDeviceGuidOculus(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetAudioOutputDeviceGuidOculus(wine_instance_from_handle((XrInstance)(uintptr_t)UlongToPtr(params->instance))->host_instance, (wchar_t *)(uintptr_t)UlongToPtr(params->buffer));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetBodySkeletonFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetBodySkeletonFB((XrBodyTrackerFB)(uintptr_t)UlongToPtr(params->bodyTracker), &skeleton_host);
...
static NTSTATUS thunk32_xrGetBodySkeletonHTC(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetBodySkeletonHTC((XrBodyTrackerHTC)(uintptr_t)UlongToPtr(params->bodyTracker), (XrSpace)(uintptr_t)UlongToPtr(params->baseSpace), params->skeletonGenerationId, &skeleton_host);
...
static NTSTATUS thunk32_xrGetControllerModelKeyMSFT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetControllerModelKeyMSFT(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->topLevelUserPath, &controllerModelKeyState_host);
...
static NTSTATUS thunk32_xrGetControllerModelPropertiesMSFT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetControllerModelPropertiesMSFT(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->modelKey, &properties_host);
...
static NTSTATUS thunk32_xrGetControllerModelStateMSFT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetControllerModelStateMSFT(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->modelKey, &state_host);
...
static NTSTATUS thunk32_xrGetCurrentInteractionProfile(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetCurrentInteractionProfile(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->topLevelUserPath, &interactionProfile_host);
...
static NTSTATUS thunk32_xrGetDeviceSampleRateFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetDeviceSampleRateFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &hapticActionInfo_host, &deviceSampleRate_host);
...
static NTSTATUS thunk32_xrGetDisplayRefreshRateFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetDisplayRefreshRateFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, (float *)(uintptr_t)UlongToPtr(params->displayRefreshRate));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetEnvironmentDepthSwapchainStateMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetEnvironmentDepthSwapchainStateMETA((XrEnvironmentDepthSwapchainMETA)(uintptr_t)UlongToPtr(params->swapchain), &state_host);
...
static NTSTATUS thunk32_xrGetExportedLocalizationMapDataML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetExportedLocalizationMapDataML((XrExportedLocalizationMapML)(uintptr_t)UlongToPtr(params->map), params->bufferCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->bufferCountOutput), (char *)(uintptr_t)UlongToPtr(params->buffer));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetEyeGazesFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetEyeGazesFB((XrEyeTrackerFB)(uintptr_t)UlongToPtr(params->eyeTracker), &gazeInfo_host, &eyeGazes_host);
...
static NTSTATUS thunk32_xrGetFaceExpressionWeights2FB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetFaceExpressionWeights2FB((XrFaceTracker2FB)(uintptr_t)UlongToPtr(params->faceTracker), &expressionInfo_host, &expressionWeights_host);
...
static NTSTATUS thunk32_xrGetFaceExpressionWeightsFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetFaceExpressionWeightsFB((XrFaceTrackerFB)(uintptr_t)UlongToPtr(params->faceTracker), &expressionInfo_host, &expressionWeights_host);
...
static NTSTATUS thunk32_xrGetFacialExpressionBlendShapePropertiesML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetFacialExpressionBlendShapePropertiesML((XrFacialExpressionClientML)(uintptr_t)UlongToPtr(params->facialExpressionClient), &blendShapeGetInfo_host, params->blendShapeCount, blendShapes_host);
...
static NTSTATUS thunk32_xrGetFacialExpressionsHTC(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetFacialExpressionsHTC((XrFacialTrackerHTC)(uintptr_t)UlongToPtr(params->facialTracker), &facialExpressions_host);
...
static NTSTATUS thunk32_xrGetFoveationEyeTrackedStateMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetFoveationEyeTrackedStateMETA(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &foveationState_host);
...
static NTSTATUS thunk32_xrGetHandMeshFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetHandMeshFB((XrHandTrackerEXT)(uintptr_t)UlongToPtr(params->handTracker), &mesh_host);
...
static NTSTATUS thunk32_xrGetInputSourceLocalizedName(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetInputSourceLocalizedName(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &getInfo_host, params->bufferCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->bufferCountOutput), (char *)(uintptr_t)UlongToPtr(params->buffer));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetInstanceProperties(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetInstanceProperties(wine_instance_from_handle((XrInstance)(uintptr_t)UlongToPtr(params->instance))->host_instance, &instanceProperties_host);
...
static NTSTATUS thunk32_xrGetMarkerDetectorStateML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetMarkerDetectorStateML((XrMarkerDetectorML)(uintptr_t)UlongToPtr(params->markerDetector), &state_host);
...
static NTSTATUS thunk32_xrGetMarkerLengthML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetMarkerLengthML((XrMarkerDetectorML)(uintptr_t)UlongToPtr(params->markerDetector), params->marker, (float *)(uintptr_t)UlongToPtr(params->meters));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetMarkerNumberML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetMarkerNumberML((XrMarkerDetectorML)(uintptr_t)UlongToPtr(params->markerDetector), params->marker, (uint64_t *)(uintptr_t)UlongToPtr(params->number));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetMarkerReprojectionErrorML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetMarkerReprojectionErrorML((XrMarkerDetectorML)(uintptr_t)UlongToPtr(params->markerDetector), params->marker, (float *)(uintptr_t)UlongToPtr(params->reprojectionErrorMeters));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetMarkerSizeVARJO(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetMarkerSizeVARJO(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->markerId, (XrExtent2Df *)(uintptr_t)UlongToPtr(params->size));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetMarkerStringML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetMarkerStringML((XrMarkerDetectorML)(uintptr_t)UlongToPtr(params->markerDetector), params->marker, params->bufferCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->bufferCountOutput), (char *)(uintptr_t)UlongToPtr(params->buffer));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetMarkersML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetMarkersML((XrMarkerDetectorML)(uintptr_t)UlongToPtr(params->markerDetector), params->markerCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->markerCountOutput), (XrMarkerML *)(uintptr_t)UlongToPtr(params->markers));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetOpenGLGraphicsRequirementsKHR(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetOpenGLGraphicsRequirementsKHR(wine_instance_from_handle((XrInstance)(uintptr_t)UlongToPtr(params->instance))->host_instance, params->systemId, &graphicsRequirements_host);
...
static NTSTATUS thunk32_xrGetPassthroughCameraStateANDROID(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetPassthroughCameraStateANDROID(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &getInfo_host, (XrPassthroughCameraStateANDROID *)(uintptr_t)UlongToPtr(params->cameraStateOutput));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetPassthroughPreferencesMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetPassthroughPreferencesMETA(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &preferences_host);
...
static NTSTATUS thunk32_xrGetPerformanceMetricsStateMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetPerformanceMetricsStateMETA(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &state_host);
...
static NTSTATUS thunk32_xrGetPlaneDetectionStateEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetPlaneDetectionStateEXT((XrPlaneDetectorEXT)(uintptr_t)UlongToPtr(params->planeDetector), (XrPlaneDetectionStateEXT *)(uintptr_t)UlongToPtr(params->state));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetPlaneDetectionsEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetPlaneDetectionsEXT((XrPlaneDetectorEXT)(uintptr_t)UlongToPtr(params->planeDetector), &info_host, &locations_host);
...
static NTSTATUS thunk32_xrGetPlanePolygonBufferEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetPlanePolygonBufferEXT((XrPlaneDetectorEXT)(uintptr_t)UlongToPtr(params->planeDetector), params->planeId, params->polygonBufferIndex, &polygonBuffer_host);
...
static NTSTATUS thunk32_xrGetQueriedSenseDataBD(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetQueriedSenseDataBD((XrSenseDataSnapshotBD)(uintptr_t)UlongToPtr(params->snapshot), &getInfo_host, &queriedSenseData_host);
...
static NTSTATUS thunk32_xrGetRecommendedLayerResolutionMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetRecommendedLayerResolutionMETA(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &info_host, &resolution_host);
...
static NTSTATUS thunk32_xrGetReferenceSpaceBoundsRect(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetReferenceSpaceBoundsRect(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->referenceSpaceType, (XrExtent2Df *)(uintptr_t)UlongToPtr(params->bounds));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetRenderModelAssetDataEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetRenderModelAssetDataEXT((XrRenderModelAssetEXT)(uintptr_t)UlongToPtr(params->asset), getInfo_host, &buffer_host);
...
static NTSTATUS thunk32_xrGetRenderModelAssetPropertiesEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetRenderModelAssetPropertiesEXT((XrRenderModelAssetEXT)(uintptr_t)UlongToPtr(params->asset), getInfo_host, &properties_host);
...
static NTSTATUS thunk32_xrGetRenderModelPoseTopLevelUserPathEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetRenderModelPoseTopLevelUserPathEXT((XrRenderModelEXT)(uintptr_t)UlongToPtr(params->renderModel), &info_host, (XrPath *)(uintptr_t)UlongToPtr(params->topLevelUserPath));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetRenderModelPropertiesEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetRenderModelPropertiesEXT((XrRenderModelEXT)(uintptr_t)UlongToPtr(params->renderModel), getInfo_host, &properties_host);
...
static NTSTATUS thunk32_xrGetRenderModelPropertiesFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetRenderModelPropertiesFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->path, &properties_host);
...
static NTSTATUS thunk32_xrGetRenderModelStateEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetRenderModelStateEXT((XrRenderModelEXT)(uintptr_t)UlongToPtr(params->renderModel), &getInfo_host, &state_host);
...
static NTSTATUS thunk32_xrGetSceneComponentsMSFT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSceneComponentsMSFT((XrSceneMSFT)(uintptr_t)UlongToPtr(params->scene), &getInfo_host, &components_host);
...
static NTSTATUS thunk32_xrGetSceneComputeStateMSFT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSceneComputeStateMSFT((XrSceneObserverMSFT)(uintptr_t)UlongToPtr(params->sceneObserver), (XrSceneComputeStateMSFT *)(uintptr_t)UlongToPtr(params->state));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetSceneMarkerDecodedStringMSFT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSceneMarkerDecodedStringMSFT((XrSceneMSFT)(uintptr_t)UlongToPtr(params->scene), (const XrUuidMSFT *)(uintptr_t)UlongToPtr(params->markerId), params->bufferCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->bufferCountOutput), (char *)(uintptr_t)UlongToPtr(params->buffer));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetSceneMarkerRawDataMSFT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSceneMarkerRawDataMSFT((XrSceneMSFT)(uintptr_t)UlongToPtr(params->scene), (const XrUuidMSFT *)(uintptr_t)UlongToPtr(params->markerId), params->bufferCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->bufferCountOutput), (uint8_t *)(uintptr_t)UlongToPtr(params->buffer));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetSceneMeshBuffersMSFT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSceneMeshBuffersMSFT((XrSceneMSFT)(uintptr_t)UlongToPtr(params->scene), &getInfo_host, &buffers_host);
...
static NTSTATUS thunk32_xrGetSenseDataProviderStateBD(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSenseDataProviderStateBD((XrSenseDataProviderBD)(uintptr_t)UlongToPtr(params->provider), (XrSenseDataProviderStateBD *)(uintptr_t)UlongToPtr(params->state));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetSerializedSceneFragmentDataMSFT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSerializedSceneFragmentDataMSFT((XrSceneMSFT)(uintptr_t)UlongToPtr(params->scene), &getInfo_host, params->countInput, (uint32_t *)(uintptr_t)UlongToPtr(params->readOutput), (uint8_t *)(uintptr_t)UlongToPtr(params->buffer));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetSpaceBoundary2DFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSpaceBoundary2DFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, (XrSpace)(uintptr_t)UlongToPtr(params->space), &boundary2DOutput_host);
...
static NTSTATUS thunk32_xrGetSpaceBoundingBox2DFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSpaceBoundingBox2DFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, (XrSpace)(uintptr_t)UlongToPtr(params->space), (XrRect2Df *)(uintptr_t)UlongToPtr(params->boundingBox2DOutput));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetSpaceBoundingBox3DFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSpaceBoundingBox3DFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, (XrSpace)(uintptr_t)UlongToPtr(params->space), (XrRect3DfFB *)(uintptr_t)UlongToPtr(params->boundingBox3DOutput));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetSpaceComponentStatusFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSpaceComponentStatusFB((XrSpace)(uintptr_t)UlongToPtr(params->space), params->componentType, &status_host);
...
static NTSTATUS thunk32_xrGetSpaceContainerFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSpaceContainerFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, (XrSpace)(uintptr_t)UlongToPtr(params->space), &spaceContainerOutput_host);
...
static NTSTATUS thunk32_xrGetSpaceRoomLayoutFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSpaceRoomLayoutFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, (XrSpace)(uintptr_t)UlongToPtr(params->space), &roomLayoutOutput_host);
...
static NTSTATUS thunk32_xrGetSpaceSemanticLabelsFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSpaceSemanticLabelsFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, (XrSpace)(uintptr_t)UlongToPtr(params->space), &semanticLabelsOutput_host);
...
static NTSTATUS thunk32_xrGetSpaceTriangleMeshMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSpaceTriangleMeshMETA((XrSpace)(uintptr_t)UlongToPtr(params->space), &getInfo_host, &triangleMeshOutput_host);
...
static NTSTATUS thunk32_xrGetSpaceUserIdFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSpaceUserIdFB((XrSpaceUserFB)(uintptr_t)UlongToPtr(params->user), (XrSpaceUserIdFB *)(uintptr_t)UlongToPtr(params->userId));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetSpaceUuidFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSpaceUuidFB((XrSpace)(uintptr_t)UlongToPtr(params->space), (XrUuidEXT *)(uintptr_t)UlongToPtr(params->uuid));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetSpatialAnchorNameHTC(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSpatialAnchorNameHTC((XrSpace)(uintptr_t)UlongToPtr(params->anchor), (XrSpatialAnchorNameHTC *)(uintptr_t)UlongToPtr(params->name));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetSpatialAnchorStateML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSpatialAnchorStateML((XrSpace)(uintptr_t)UlongToPtr(params->anchor), &state_host);
...
static NTSTATUS thunk32_xrGetSpatialBufferFloatEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSpatialBufferFloatEXT((XrSpatialSnapshotEXT)(uintptr_t)UlongToPtr(params->snapshot), &info_host, params->bufferCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->bufferCountOutput), (float *)(uintptr_t)UlongToPtr(params->buffer));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetSpatialBufferStringEXT(void *args)
{
    ...
    convert_XrSpatialBufferGetInfoEXT_win32_to_host((const XrSpatialBufferGetInfoEXT32 *)(uintptr_t)UlongToPtr(params->info), &info_host);
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSpatialBufferStringEXT((XrSpatialSnapshotEXT)(uintptr_t)UlongToPtr(params->snapshot), &info_host, params->bufferCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->bufferCountOutput), (char *)(uintptr_t)UlongToPtr(params->buffer));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetSpatialBufferUint16EXT(void *args)
{
    ...
    convert_XrSpatialBufferGetInfoEXT_win32_to_host((const XrSpatialBufferGetInfoEXT32 *)(uintptr_t)UlongToPtr(params->info), &info_host);
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSpatialBufferUint16EXT((XrSpatialSnapshotEXT)(uintptr_t)UlongToPtr(params->snapshot), &info_host, params->bufferCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->bufferCountOutput), (uint16_t *)(uintptr_t)UlongToPtr(params->buffer));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetSpatialBufferUint32EXT(void *args)
{
    ...
    convert_XrSpatialBufferGetInfoEXT_win32_to_host((const XrSpatialBufferGetInfoEXT32 *)(uintptr_t)UlongToPtr(params->info), &info_host);
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSpatialBufferUint32EXT((XrSpatialSnapshotEXT)(uintptr_t)UlongToPtr(params->snapshot), &info_host, params->bufferCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->bufferCountOutput), (uint32_t *)(uintptr_t)UlongToPtr(params->buffer));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetSpatialBufferUint8EXT(void *args)
{
    ...
    convert_XrSpatialBufferGetInfoEXT_win32_to_host((const XrSpatialBufferGetInfoEXT32 *)(uintptr_t)UlongToPtr(params->info), &info_host);
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSpatialBufferUint8EXT((XrSpatialSnapshotEXT)(uintptr_t)UlongToPtr(params->snapshot), &info_host, params->bufferCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->bufferCountOutput), (uint8_t *)(uintptr_t)UlongToPtr(params->buffer));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetSpatialBufferVector2fEXT(void *args)
{
    ...
    convert_XrSpatialBufferGetInfoEXT_win32_to_host((const XrSpatialBufferGetInfoEXT32 *)(uintptr_t)UlongToPtr(params->info), &info_host);
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSpatialBufferVector2fEXT((XrSpatialSnapshotEXT)(uintptr_t)UlongToPtr(params->snapshot), &info_host, params->bufferCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->bufferCountOutput), (XrVector2f *)(uintptr_t)UlongToPtr(params->buffer));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetSpatialBufferVector3fEXT(void *args)
{
    ...
    convert_XrSpatialBufferGetInfoEXT_win32_to_host((const XrSpatialBufferGetInfoEXT32 *)(uintptr_t)UlongToPtr(params->info), &info_host);
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSpatialBufferVector3fEXT((XrSpatialSnapshotEXT)(uintptr_t)UlongToPtr(params->snapshot), &info_host, params->bufferCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->bufferCountOutput), (XrVector3f *)(uintptr_t)UlongToPtr(params->buffer));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetSpatialEntityComponentDataBD(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSpatialEntityComponentDataBD((XrSenseDataSnapshotBD)(uintptr_t)UlongToPtr(params->snapshot), &getInfo_host, &componentData_host);
...
static NTSTATUS thunk32_xrGetSpatialEntityUuidBD(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSpatialEntityUuidBD((XrSenseDataSnapshotBD)(uintptr_t)UlongToPtr(params->snapshot), params->entityId, (XrUuidEXT *)(uintptr_t)UlongToPtr(params->uuid));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetSpatialGraphNodeBindingPropertiesMSFT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSpatialGraphNodeBindingPropertiesMSFT((XrSpatialGraphNodeBindingMSFT)(uintptr_t)UlongToPtr(params->nodeBinding), getInfo_host, &properties_host);
...
static NTSTATUS thunk32_xrGetSwapchainStateFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSwapchainStateFB(wine_swapchain_from_handle((XrSwapchain)(uintptr_t)UlongToPtr(params->swapchain))->host_swapchain, &state_host);
...
static NTSTATUS thunk32_xrGetSystem(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSystem(wine_instance_from_handle((XrInstance)(uintptr_t)UlongToPtr(params->instance))->host_instance, &getInfo_host, (XrSystemId *)(uintptr_t)UlongToPtr(params->systemId));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetSystemProperties(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetSystemProperties(wine_instance_from_handle((XrInstance)(uintptr_t)UlongToPtr(params->instance))->host_instance, params->systemId, &properties_host);
...
static NTSTATUS thunk32_xrGetTrackableMarkerANDROID(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetTrackableMarkerANDROID((XrTrackableTrackerANDROID)(uintptr_t)UlongToPtr(params->tracker), &getInfo_host, &markerOutput_host);
...
static NTSTATUS thunk32_xrGetTrackableObjectANDROID(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetTrackableObjectANDROID((XrTrackableTrackerANDROID)(uintptr_t)UlongToPtr(params->tracker), &getInfo_host, &objectOutput_host);
...
static NTSTATUS thunk32_xrGetTrackablePlaneANDROID(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetTrackablePlaneANDROID((XrTrackableTrackerANDROID)(uintptr_t)UlongToPtr(params->trackableTracker), &getInfo_host, &planeOutput_host);
...
static NTSTATUS thunk32_xrGetViewConfigurationProperties(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetViewConfigurationProperties(wine_instance_from_handle((XrInstance)(uintptr_t)UlongToPtr(params->instance))->host_instance, params->systemId, params->viewConfigurationType, &configurationProperties_host);
...
static NTSTATUS thunk32_xrGetVirtualKeyboardDirtyTexturesMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetVirtualKeyboardDirtyTexturesMETA((XrVirtualKeyboardMETA)(uintptr_t)UlongToPtr(params->keyboard), params->textureIdCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->textureIdCountOutput), (uint64_t *)(uintptr_t)UlongToPtr(params->textureIds));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetVirtualKeyboardModelAnimationStatesMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetVirtualKeyboardModelAnimationStatesMETA((XrVirtualKeyboardMETA)(uintptr_t)UlongToPtr(params->keyboard), &animationStates_host);
...
static NTSTATUS thunk32_xrGetVirtualKeyboardScaleMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetVirtualKeyboardScaleMETA((XrVirtualKeyboardMETA)(uintptr_t)UlongToPtr(params->keyboard), (float *)(uintptr_t)UlongToPtr(params->scale));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetVirtualKeyboardTextureDataMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetVirtualKeyboardTextureDataMETA((XrVirtualKeyboardMETA)(uintptr_t)UlongToPtr(params->keyboard), params->textureId, &textureData_host);
...
static NTSTATUS thunk32_xrGetVisibilityMaskKHR(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetVisibilityMaskKHR(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->viewConfigurationType, params->viewIndex, params->visibilityMaskType, &visibilityMask_host);
...
static NTSTATUS thunk32_xrGetVulkanDeviceExtensionsKHR(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetVulkanDeviceExtensionsKHR(wine_instance_from_handle((XrInstance)(uintptr_t)UlongToPtr(params->instance))->host_instance, params->systemId, params->bufferCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->bufferCountOutput), (char *)(uintptr_t)UlongToPtr(params->buffer));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetVulkanGraphicsDevice2KHR(void *args)
{
    ...
    params->result = wine_xrGetVulkanGraphicsDevice2KHR((XrInstance)(uintptr_t)UlongToPtr(params->instance), &getInfo_host, (VkPhysicalDevice *)(uintptr_t)UlongToPtr(params->vulkanPhysicalDevice));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetVulkanGraphicsDeviceKHR(void *args)
{
    ...
    params->result = wine_xrGetVulkanGraphicsDeviceKHR((XrInstance)(uintptr_t)UlongToPtr(params->instance), params->systemId, params->vkInstance, (VkPhysicalDevice *)(uintptr_t)UlongToPtr(params->vkPhysicalDevice));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetVulkanGraphicsRequirements2KHR(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetVulkanGraphicsRequirements2KHR(wine_instance_from_handle((XrInstance)(uintptr_t)UlongToPtr(params->instance))->host_instance, params->systemId, &graphicsRequirements_host);
...
static NTSTATUS thunk32_xrGetVulkanGraphicsRequirementsKHR(void *args)
{
    ...
    convert_XrGraphicsRequirementsVulkanKHR_win32_to_host((XrGraphicsRequirementsVulkanKHR32 *)(uintptr_t)UlongToPtr(params->graphicsRequirements), &graphicsRequirements_host);
    params->result = g_xr_host_instance_dispatch_table.p_xrGetVulkanGraphicsRequirementsKHR(wine_instance_from_handle((XrInstance)(uintptr_t)UlongToPtr(params->instance))->host_instance, params->systemId, &graphicsRequirements_host);
    convert_XrGraphicsRequirementsVulkanKHR_host_to_win32(&graphicsRequirements_host, (XrGraphicsRequirementsVulkanKHR32 *)(XrGraphicsRequirementsVulkanKHR32 *)(uintptr_t)UlongToPtr(params->graphicsRequirements));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetVulkanInstanceExtensionsKHR(void *args)
{
    ...
    params->result = wine_xrGetVulkanInstanceExtensionsKHR((XrInstance)(uintptr_t)UlongToPtr(params->instance), params->systemId, params->bufferCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->bufferCountOutput), (char *)(uintptr_t)UlongToPtr(params->buffer));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrGetWorldMeshBufferRecommendSizeML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrGetWorldMeshBufferRecommendSizeML((XrWorldMeshDetectorML)(uintptr_t)UlongToPtr(params->detector), &sizeInfo_host, &size_host);
...
static NTSTATUS thunk32_xrImportLocalizationMapML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrImportLocalizationMapML(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &importInfo_host, (XrUuidEXT *)(uintptr_t)UlongToPtr(params->mapUuid));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrLoadControllerModelMSFT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrLoadControllerModelMSFT(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->modelKey, params->bufferCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->bufferCountOutput), (uint8_t *)(uintptr_t)UlongToPtr(params->buffer));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrLoadRenderModelFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrLoadRenderModelFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &info_host, &buffer_host);
...
static NTSTATUS thunk32_xrLocateBodyJointsBD(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrLocateBodyJointsBD((XrBodyTrackerBD)(uintptr_t)UlongToPtr(params->bodyTracker), &locateInfo_host, &locations_host);
...
static NTSTATUS thunk32_xrLocateBodyJointsFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrLocateBodyJointsFB((XrBodyTrackerFB)(uintptr_t)UlongToPtr(params->bodyTracker), &locateInfo_host, &locations_host);
...
static NTSTATUS thunk32_xrLocateBodyJointsHTC(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrLocateBodyJointsHTC((XrBodyTrackerHTC)(uintptr_t)UlongToPtr(params->bodyTracker), &locateInfo_host, &locations_host);
...
static NTSTATUS thunk32_xrLocateHandJointsEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrLocateHandJointsEXT((XrHandTrackerEXT)(uintptr_t)UlongToPtr(params->handTracker), &locateInfo_host, &locations_host);
...
static NTSTATUS thunk32_xrLocateSceneComponentsMSFT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrLocateSceneComponentsMSFT((XrSceneMSFT)(uintptr_t)UlongToPtr(params->scene), &locateInfo_host, &locations_host);
...
static NTSTATUS thunk32_xrLocateSpace(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrLocateSpace((XrSpace)(uintptr_t)UlongToPtr(params->space), (XrSpace)(uintptr_t)UlongToPtr(params->baseSpace), params->time, &location_host);
...
static NTSTATUS thunk32_xrLocateSpaces(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrLocateSpaces(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &locateInfo_host, &spaceLocations_host);
...
static NTSTATUS thunk32_xrLocateSpacesKHR(void *args)
{
    ...
    convert_XrSpacesLocateInfo_win32_to_host(ctx, (const XrSpacesLocateInfo32 *)(uintptr_t)UlongToPtr(params->locateInfo), &locateInfo_host);
    convert_XrSpaceLocations_win32_to_host(ctx, (XrSpaceLocations32 *)(uintptr_t)UlongToPtr(params->spaceLocations), &spaceLocations_host);
    params->result = g_xr_host_instance_dispatch_table.p_xrLocateSpacesKHR(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &locateInfo_host, &spaceLocations_host);
    convert_XrSpaceLocations_host_to_win32(&spaceLocations_host, (XrSpaceLocations32 *)(XrSpaceLocations32 *)(uintptr_t)UlongToPtr(params->spaceLocations));
    free_conversion_context(ctx);
    return STATUS_SUCCESS;
}
...
static NTSTATUS thunk32_xrLocateViews(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrLocateViews(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &viewLocateInfo_host, &viewState_host, params->viewCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->viewCountOutput), views_host);
...
static NTSTATUS thunk32_xrPassthroughLayerPauseFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrPassthroughLayerPauseFB((XrPassthroughLayerFB)(uintptr_t)UlongToPtr(params->layer));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrPassthroughLayerResumeFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrPassthroughLayerResumeFB((XrPassthroughLayerFB)(uintptr_t)UlongToPtr(params->layer));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrPassthroughLayerSetKeyboardHandsIntensityFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrPassthroughLayerSetKeyboardHandsIntensityFB((XrPassthroughLayerFB)(uintptr_t)UlongToPtr(params->layer), &intensity_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrPassthroughLayerSetStyleFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrPassthroughLayerSetStyleFB((XrPassthroughLayerFB)(uintptr_t)UlongToPtr(params->layer), &style_host);
    free_conversion_context(ctx);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrPassthroughPauseFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrPassthroughPauseFB((XrPassthroughFB)(uintptr_t)UlongToPtr(params->passthrough));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrPassthroughStartFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrPassthroughStartFB((XrPassthroughFB)(uintptr_t)UlongToPtr(params->passthrough));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrPathToString(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrPathToString(wine_instance_from_handle((XrInstance)(uintptr_t)UlongToPtr(params->instance))->host_instance, params->path, params->bufferCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->bufferCountOutput), (char *)(uintptr_t)UlongToPtr(params->buffer));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrPauseSimultaneousHandsAndControllersTrackingMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrPauseSimultaneousHandsAndControllersTrackingMETA(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &pauseInfo_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrPerfSettingsSetPerformanceLevelEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrPerfSettingsSetPerformanceLevelEXT(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->domain, params->level);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrPersistAnchorANDROID(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrPersistAnchorANDROID((XrDeviceAnchorPersistenceANDROID)(uintptr_t)UlongToPtr(params->handle), &persistedInfo_host, (XrUuidEXT *)(uintptr_t)UlongToPtr(params->anchorIdOutput));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrPersistSpatialAnchorAsyncBD(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrPersistSpatialAnchorAsyncBD((XrSenseDataProviderBD)(uintptr_t)UlongToPtr(params->provider), &info_host, (XrFutureEXT *)(uintptr_t)UlongToPtr(params->future));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrPersistSpatialAnchorCompleteBD(void *args)
{
    ...
    convert_XrFutureCompletionEXT_win32_to_host((XrFutureCompletionEXT32 *)(uintptr_t)UlongToPtr(params->completion), &completion_host);
    params->result = g_xr_host_instance_dispatch_table.p_xrPersistSpatialAnchorCompleteBD((XrSenseDataProviderBD)(uintptr_t)UlongToPtr(params->provider), params->future, &completion_host);
    convert_XrFutureCompletionEXT_host_to_win32(&completion_host, (XrFutureCompletionEXT32 *)(XrFutureCompletionEXT32 *)(uintptr_t)UlongToPtr(params->completion));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrPersistSpatialAnchorMSFT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrPersistSpatialAnchorMSFT((XrSpatialAnchorStoreConnectionMSFT)(uintptr_t)UlongToPtr(params->spatialAnchorStore), &spatialAnchorPersistenceInfo_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrPersistSpatialEntityAsyncEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrPersistSpatialEntityAsyncEXT((XrSpatialPersistenceContextEXT)(uintptr_t)UlongToPtr(params->persistenceContext), &persistInfo_host, (XrFutureEXT *)(uintptr_t)UlongToPtr(params->future));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrPersistSpatialEntityCompleteEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrPersistSpatialEntityCompleteEXT((XrSpatialPersistenceContextEXT)(uintptr_t)UlongToPtr(params->persistenceContext), params->future, &completion_host);
...
static NTSTATUS thunk32_xrPollEvent(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrPollEvent(wine_instance_from_handle((XrInstance)(uintptr_t)UlongToPtr(params->instance))->host_instance, &eventData_host);
...
static NTSTATUS thunk32_xrPollFutureEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrPollFutureEXT(wine_instance_from_handle((XrInstance)(uintptr_t)UlongToPtr(params->instance))->host_instance, &pollInfo_host, &pollResult_host);
...
static NTSTATUS thunk32_xrPublishSpatialAnchorsAsyncML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrPublishSpatialAnchorsAsyncML((XrSpatialAnchorsStorageML)(uintptr_t)UlongToPtr(params->storage), &publishInfo_host, (XrFutureEXT *)(uintptr_t)UlongToPtr(params->future));
    free_conversion_context(ctx);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrPublishSpatialAnchorsCompleteML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrPublishSpatialAnchorsCompleteML((XrSpatialAnchorsStorageML)(uintptr_t)UlongToPtr(params->storage), params->future, &completion_host);
...
static NTSTATUS thunk32_xrQueryLocalizationMapsML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrQueryLocalizationMapsML(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, queryInfo_host, params->mapCapacityInput, (uint32_t *)(uintptr_t)UlongToPtr(params->mapCountOutput), maps_host);
...
static NTSTATUS thunk32_xrQueryPerformanceMetricsCounterMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrQueryPerformanceMetricsCounterMETA(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->counterPath, &counter_host);
...
static NTSTATUS thunk32_xrQuerySenseDataAsyncBD(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrQuerySenseDataAsyncBD((XrSenseDataProviderBD)(uintptr_t)UlongToPtr(params->provider), &queryInfo_host, (XrFutureEXT *)(uintptr_t)UlongToPtr(params->future));
    free_conversion_context(ctx);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrQuerySenseDataCompleteBD(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrQuerySenseDataCompleteBD((XrSenseDataProviderBD)(uintptr_t)UlongToPtr(params->provider), params->future, &completion_host);
...
static NTSTATUS thunk32_xrQuerySpacesFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrQuerySpacesFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &info_host, (XrAsyncRequestIdFB *)(uintptr_t)UlongToPtr(params->requestId));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrQuerySpatialAnchorsAsyncML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrQuerySpatialAnchorsAsyncML((XrSpatialAnchorsStorageML)(uintptr_t)UlongToPtr(params->storage), &queryInfo_host, (XrFutureEXT *)(uintptr_t)UlongToPtr(params->future));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrQuerySpatialAnchorsCompleteML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrQuerySpatialAnchorsCompleteML((XrSpatialAnchorsStorageML)(uintptr_t)UlongToPtr(params->storage), params->future, &completion_host);
...
static NTSTATUS thunk32_xrQuerySpatialComponentDataEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrQuerySpatialComponentDataEXT((XrSpatialSnapshotEXT)(uintptr_t)UlongToPtr(params->snapshot), &queryCondition_host, &queryResult_host);
...
static NTSTATUS thunk32_xrQuerySystemTrackedKeyboardFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrQuerySystemTrackedKeyboardFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &queryInfo_host, &keyboard_host);
...
static NTSTATUS thunk32_xrRaycastANDROID(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrRaycastANDROID(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &rayInfo_host, &results_host);
...
static NTSTATUS thunk32_xrReleaseSwapchainImage(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrReleaseSwapchainImage(wine_swapchain_from_handle((XrSwapchain)(uintptr_t)UlongToPtr(params->swapchain))->host_swapchain, releaseInfo_host);
    free_conversion_context(ctx);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrRequestDisplayRefreshRateFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrRequestDisplayRefreshRateFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->displayRefreshRate);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrRequestExitSession(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrRequestExitSession(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrRequestMapLocalizationML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrRequestMapLocalizationML(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &requestInfo_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrRequestSceneCaptureFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrRequestSceneCaptureFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &info_host, (XrAsyncRequestIdFB *)(uintptr_t)UlongToPtr(params->requestId));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrRequestWorldMeshAsyncML(void *args)
{
    ...
    convert_XrWorldMeshBufferML_win32_to_host((XrWorldMeshBufferML32 *)(uintptr_t)UlongToPtr(params->buffer), &buffer_host);
    params->result = g_xr_host_instance_dispatch_table.p_xrRequestWorldMeshAsyncML((XrWorldMeshDetectorML)(uintptr_t)UlongToPtr(params->detector), &getInfo_host, &buffer_host, (XrFutureEXT *)(uintptr_t)UlongToPtr(params->future));
...
static NTSTATUS thunk32_xrRequestWorldMeshCompleteML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrRequestWorldMeshCompleteML((XrWorldMeshDetectorML)(uintptr_t)UlongToPtr(params->detector), &completionInfo_host, params->future, &completion_host);
...
static NTSTATUS thunk32_xrRequestWorldMeshStateAsyncML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrRequestWorldMeshStateAsyncML((XrWorldMeshDetectorML)(uintptr_t)UlongToPtr(params->detector), &stateRequest_host, (XrFutureEXT *)(uintptr_t)UlongToPtr(params->future));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrRequestWorldMeshStateCompleteML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrRequestWorldMeshStateCompleteML((XrWorldMeshDetectorML)(uintptr_t)UlongToPtr(params->detector), params->future, &completion_host);
...
static NTSTATUS thunk32_xrResetBodyTrackingCalibrationMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrResetBodyTrackingCalibrationMETA((XrBodyTrackerFB)(uintptr_t)UlongToPtr(params->bodyTracker));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrResultToString(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrResultToString(wine_instance_from_handle((XrInstance)(uintptr_t)UlongToPtr(params->instance))->host_instance, params->value, (char *)(uintptr_t)UlongToPtr(params->buffer));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrResumeSimultaneousHandsAndControllersTrackingMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrResumeSimultaneousHandsAndControllersTrackingMETA(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &resumeInfo_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrRetrieveSpaceDiscoveryResultsMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrRetrieveSpaceDiscoveryResultsMETA(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->requestId, &results_host);
...
static NTSTATUS thunk32_xrRetrieveSpaceQueryResultsFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrRetrieveSpaceQueryResultsFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->requestId, &results_host);
...
static NTSTATUS thunk32_xrSaveSpaceFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrSaveSpaceFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &info_host, (XrAsyncRequestIdFB *)(uintptr_t)UlongToPtr(params->requestId));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrSaveSpaceListFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrSaveSpaceListFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &info_host, (XrAsyncRequestIdFB *)(uintptr_t)UlongToPtr(params->requestId));
...
static NTSTATUS thunk32_xrSaveSpacesMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrSaveSpacesMETA(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &info_host, (XrAsyncRequestIdFB *)(uintptr_t)UlongToPtr(params->requestId));
...
static NTSTATUS thunk32_xrSendVirtualKeyboardInputMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrSendVirtualKeyboardInputMETA((XrVirtualKeyboardMETA)(uintptr_t)UlongToPtr(params->keyboard), &info_host, (XrPosef *)(uintptr_t)UlongToPtr(params->interactorRootPose));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrSetColorSpaceFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrSetColorSpaceFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->colorSpace);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrSetDigitalLensControlALMALENCE(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrSetDigitalLensControlALMALENCE(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &digitalLensControl_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrSetEnvironmentDepthEstimationVARJO(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrSetEnvironmentDepthEstimationVARJO(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->enabled);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrSetEnvironmentDepthHandRemovalMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrSetEnvironmentDepthHandRemovalMETA((XrEnvironmentDepthProviderMETA)(uintptr_t)UlongToPtr(params->environmentDepthProvider), &setInfo_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrSetInputDeviceActiveEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrSetInputDeviceActiveEXT(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->interactionProfile, params->topLevelPath, params->isActive);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrSetInputDeviceLocationEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrSetInputDeviceLocationEXT(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->topLevelPath, params->inputSourcePath, (XrSpace)(uintptr_t)UlongToPtr(params->space), params->pose);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrSetInputDeviceStateBoolEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrSetInputDeviceStateBoolEXT(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->topLevelPath, params->inputSourcePath, params->state);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrSetInputDeviceStateFloatEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrSetInputDeviceStateFloatEXT(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->topLevelPath, params->inputSourcePath, params->state);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrSetInputDeviceStateVector2fEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrSetInputDeviceStateVector2fEXT(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->topLevelPath, params->inputSourcePath, params->state);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrSetMarkerTrackingPredictionVARJO(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrSetMarkerTrackingPredictionVARJO(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->markerId, params->enable);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrSetMarkerTrackingTimeoutVARJO(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrSetMarkerTrackingTimeoutVARJO(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->markerId, params->timeout);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrSetMarkerTrackingVARJO(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrSetMarkerTrackingVARJO(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->enabled);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrSetPerformanceMetricsStateMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrSetPerformanceMetricsStateMETA(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &state_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrSetSpaceComponentStatusFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrSetSpaceComponentStatusFB((XrSpace)(uintptr_t)UlongToPtr(params->space), &info_host, (XrAsyncRequestIdFB *)(uintptr_t)UlongToPtr(params->requestId));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrSetSystemNotificationsML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrSetSystemNotificationsML(wine_instance_from_handle((XrInstance)(uintptr_t)UlongToPtr(params->instance))->host_instance, &info_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrSetTrackingOptimizationSettingsHintQCOM(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrSetTrackingOptimizationSettingsHintQCOM(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->domain, params->hint);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrSetViewOffsetVARJO(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrSetViewOffsetVARJO(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->offset);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrSetVirtualKeyboardModelVisibilityMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrSetVirtualKeyboardModelVisibilityMETA((XrVirtualKeyboardMETA)(uintptr_t)UlongToPtr(params->keyboard), &modelVisibility_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrShareSpacesFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrShareSpacesFB(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &info_host, (XrAsyncRequestIdFB *)(uintptr_t)UlongToPtr(params->requestId));
...
static NTSTATUS thunk32_xrShareSpacesMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrShareSpacesMETA(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &info_host, (XrAsyncRequestIdFB *)(uintptr_t)UlongToPtr(params->requestId));
...
static NTSTATUS thunk32_xrShareSpatialAnchorAsyncBD(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrShareSpatialAnchorAsyncBD((XrSenseDataProviderBD)(uintptr_t)UlongToPtr(params->provider), &info_host, (XrFutureEXT *)(uintptr_t)UlongToPtr(params->future));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrShareSpatialAnchorCompleteBD(void *args)
{
    ...
    convert_XrFutureCompletionEXT_win32_to_host((XrFutureCompletionEXT32 *)(uintptr_t)UlongToPtr(params->completion), &completion_host);
    params->result = g_xr_host_instance_dispatch_table.p_xrShareSpatialAnchorCompleteBD((XrSenseDataProviderBD)(uintptr_t)UlongToPtr(params->provider), params->future, &completion_host);
    convert_XrFutureCompletionEXT_host_to_win32(&completion_host, (XrFutureCompletionEXT32 *)(XrFutureCompletionEXT32 *)(uintptr_t)UlongToPtr(params->completion));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrSnapshotMarkerDetectorML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrSnapshotMarkerDetectorML((XrMarkerDetectorML)(uintptr_t)UlongToPtr(params->markerDetector), &snapshotInfo_host);
...
static NTSTATUS thunk32_xrStartColocationAdvertisementMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrStartColocationAdvertisementMETA(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &info_host, (XrAsyncRequestIdFB *)(uintptr_t)UlongToPtr(params->advertisementRequestId));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrStartColocationDiscoveryMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrStartColocationDiscoveryMETA(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &info_host, (XrAsyncRequestIdFB *)(uintptr_t)UlongToPtr(params->discoveryRequestId));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrStartEnvironmentDepthProviderMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrStartEnvironmentDepthProviderMETA((XrEnvironmentDepthProviderMETA)(uintptr_t)UlongToPtr(params->environmentDepthProvider));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrStartSenseDataProviderAsyncBD(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrStartSenseDataProviderAsyncBD((XrSenseDataProviderBD)(uintptr_t)UlongToPtr(params->provider), &startInfo_host, (XrFutureEXT *)(uintptr_t)UlongToPtr(params->future));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrStartSenseDataProviderCompleteBD(void *args)
{
    ...
    convert_XrFutureCompletionEXT_win32_to_host((XrFutureCompletionEXT32 *)(uintptr_t)UlongToPtr(params->completion), &completion_host);
    params->result = g_xr_host_instance_dispatch_table.p_xrStartSenseDataProviderCompleteBD(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->future, &completion_host);
    convert_XrFutureCompletionEXT_host_to_win32(&completion_host, (XrFutureCompletionEXT32 *)(XrFutureCompletionEXT32 *)(uintptr_t)UlongToPtr(params->completion));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrStopColocationAdvertisementMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrStopColocationAdvertisementMETA(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &info_host, (XrAsyncRequestIdFB *)(uintptr_t)UlongToPtr(params->requestId));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrStopColocationDiscoveryMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrStopColocationDiscoveryMETA(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &info_host, (XrAsyncRequestIdFB *)(uintptr_t)UlongToPtr(params->requestId));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrStopEnvironmentDepthProviderMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrStopEnvironmentDepthProviderMETA((XrEnvironmentDepthProviderMETA)(uintptr_t)UlongToPtr(params->environmentDepthProvider));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrStopHapticFeedback(void *args)
{
    ...
    convert_XrHapticActionInfo_win32_to_host((const XrHapticActionInfo32 *)(uintptr_t)UlongToPtr(params->hapticActionInfo), &hapticActionInfo_host);
    params->result = g_xr_host_instance_dispatch_table.p_xrStopHapticFeedback(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &hapticActionInfo_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrStopSenseDataProviderBD(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrStopSenseDataProviderBD((XrSenseDataProviderBD)(uintptr_t)UlongToPtr(params->provider));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrStringToPath(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrStringToPath(wine_instance_from_handle((XrInstance)(uintptr_t)UlongToPtr(params->instance))->host_instance, (const char *)(uintptr_t)UlongToPtr(params->pathString), (XrPath *)(uintptr_t)UlongToPtr(params->path));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrStructureTypeToString(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrStructureTypeToString(wine_instance_from_handle((XrInstance)(uintptr_t)UlongToPtr(params->instance))->host_instance, params->value, (char *)(uintptr_t)UlongToPtr(params->buffer));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrStructureTypeToString2KHR(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrStructureTypeToString2KHR(wine_instance_from_handle((XrInstance)(uintptr_t)UlongToPtr(params->instance))->host_instance, params->value, (char *)(uintptr_t)UlongToPtr(params->buffer));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrSuggestBodyTrackingCalibrationOverrideMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrSuggestBodyTrackingCalibrationOverrideMETA((XrBodyTrackerFB)(uintptr_t)UlongToPtr(params->bodyTracker), &calibrationInfo_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrSuggestInteractionProfileBindings(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrSuggestInteractionProfileBindings(wine_instance_from_handle((XrInstance)(uintptr_t)UlongToPtr(params->instance))->host_instance, &suggestedBindings_host);
    free_conversion_context(ctx);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrSuggestVirtualKeyboardLocationMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrSuggestVirtualKeyboardLocationMETA((XrVirtualKeyboardMETA)(uintptr_t)UlongToPtr(params->keyboard), &locationInfo_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrSyncActions(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrSyncActions(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &syncInfo_host);
    free_conversion_context(ctx);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrThermalGetTemperatureTrendEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrThermalGetTemperatureTrendEXT(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, params->domain, (XrPerfSettingsNotificationLevelEXT *)(uintptr_t)UlongToPtr(params->notificationLevel), (float *)(uintptr_t)UlongToPtr(params->tempHeadroom), (float *)(uintptr_t)UlongToPtr(params->tempSlope));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrTriangleMeshBeginUpdateFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrTriangleMeshBeginUpdateFB((XrTriangleMeshFB)(uintptr_t)UlongToPtr(params->mesh));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrTriangleMeshBeginVertexBufferUpdateFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrTriangleMeshBeginVertexBufferUpdateFB((XrTriangleMeshFB)(uintptr_t)UlongToPtr(params->mesh), (uint32_t *)(uintptr_t)UlongToPtr(params->outVertexCount));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrTriangleMeshEndUpdateFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrTriangleMeshEndUpdateFB((XrTriangleMeshFB)(uintptr_t)UlongToPtr(params->mesh), params->vertexCount, params->triangleCount);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrTriangleMeshEndVertexBufferUpdateFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrTriangleMeshEndVertexBufferUpdateFB((XrTriangleMeshFB)(uintptr_t)UlongToPtr(params->mesh));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrTriangleMeshGetIndexBufferFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrTriangleMeshGetIndexBufferFB((XrTriangleMeshFB)(uintptr_t)UlongToPtr(params->mesh), (uint32_t **)(uintptr_t)UlongToPtr(params->outIndexBuffer));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrTriangleMeshGetVertexBufferFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrTriangleMeshGetVertexBufferFB((XrTriangleMeshFB)(uintptr_t)UlongToPtr(params->mesh), (XrVector3f **)(uintptr_t)UlongToPtr(params->outVertexBuffer));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrTryCreateSpatialGraphStaticNodeBindingMSFT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrTryCreateSpatialGraphStaticNodeBindingMSFT(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, &createInfo_host, &nodeBinding_host);
...
static NTSTATUS thunk32_xrUnpersistAnchorANDROID(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrUnpersistAnchorANDROID((XrDeviceAnchorPersistenceANDROID)(uintptr_t)UlongToPtr(params->handle), (const XrUuidEXT *)(uintptr_t)UlongToPtr(params->anchorId));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrUnpersistSpatialAnchorAsyncBD(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrUnpersistSpatialAnchorAsyncBD((XrSenseDataProviderBD)(uintptr_t)UlongToPtr(params->provider), &info_host, (XrFutureEXT *)(uintptr_t)UlongToPtr(params->future));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrUnpersistSpatialAnchorCompleteBD(void *args)
{
    ...
    convert_XrFutureCompletionEXT_win32_to_host((XrFutureCompletionEXT32 *)(uintptr_t)UlongToPtr(params->completion), &completion_host);
    params->result = g_xr_host_instance_dispatch_table.p_xrUnpersistSpatialAnchorCompleteBD((XrSenseDataProviderBD)(uintptr_t)UlongToPtr(params->provider), params->future, &completion_host);
    convert_XrFutureCompletionEXT_host_to_win32(&completion_host, (XrFutureCompletionEXT32 *)(XrFutureCompletionEXT32 *)(uintptr_t)UlongToPtr(params->completion));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrUnpersistSpatialAnchorMSFT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrUnpersistSpatialAnchorMSFT((XrSpatialAnchorStoreConnectionMSFT)(uintptr_t)UlongToPtr(params->spatialAnchorStore), (const XrSpatialAnchorPersistenceNameMSFT *)(uintptr_t)UlongToPtr(params->spatialAnchorPersistenceName));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrUnpersistSpatialEntityAsyncEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrUnpersistSpatialEntityAsyncEXT((XrSpatialPersistenceContextEXT)(uintptr_t)UlongToPtr(params->persistenceContext), &unpersistInfo_host, (XrFutureEXT *)(uintptr_t)UlongToPtr(params->future));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrUnpersistSpatialEntityCompleteEXT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrUnpersistSpatialEntityCompleteEXT((XrSpatialPersistenceContextEXT)(uintptr_t)UlongToPtr(params->persistenceContext), params->future, &completion_host);
...
static NTSTATUS thunk32_xrUpdateHandMeshMSFT(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrUpdateHandMeshMSFT((XrHandTrackerEXT)(uintptr_t)UlongToPtr(params->handTracker), &updateInfo_host, &handMesh_host);
...
static NTSTATUS thunk32_xrUpdatePassthroughColorLutMETA(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrUpdatePassthroughColorLutMETA((XrPassthroughColorLutMETA)(uintptr_t)UlongToPtr(params->colorLut), &updateInfo_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrUpdateSpatialAnchorsExpirationAsyncML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrUpdateSpatialAnchorsExpirationAsyncML((XrSpatialAnchorsStorageML)(uintptr_t)UlongToPtr(params->storage), &updateInfo_host, (XrFutureEXT *)(uintptr_t)UlongToPtr(params->future));
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrUpdateSpatialAnchorsExpirationCompleteML(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrUpdateSpatialAnchorsExpirationCompleteML((XrSpatialAnchorsStorageML)(uintptr_t)UlongToPtr(params->storage), params->future, &completion_host);
...
static NTSTATUS thunk32_xrUpdateSwapchainFB(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrUpdateSwapchainFB(wine_swapchain_from_handle((XrSwapchain)(uintptr_t)UlongToPtr(params->swapchain))->host_swapchain, &state_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
...
static NTSTATUS thunk32_xrWaitFrame(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrWaitFrame(wine_session_from_handle((XrSession)(uintptr_t)UlongToPtr(params->session))->host_session, frameWaitInfo_host, &frameState_host);
...
static NTSTATUS thunk32_xrWaitSwapchainImage(void *args)
{
    ...
    params->result = g_xr_host_instance_dispatch_table.p_xrWaitSwapchainImage(wine_swapchain_from_handle((XrSwapchain)(uintptr_t)UlongToPtr(params->swapchain))->host_swapchain, &waitInfo_host);
    return STATUS_SUCCESS;
}
#endif /* !_WIN64 */
